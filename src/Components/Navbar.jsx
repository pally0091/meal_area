...
const Navbar = () => {
    return (
        <div className='flex lg:flex-row md:flex-row sm:flex-col min-[320px]:flex-col justify-between px-8 py-4 bg-gradient-to-r from-rose-500  to-violet-300 items-center shadow-xl shadow-yellow-300 mb-5 '>
            <div>
